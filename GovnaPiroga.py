...
class COXOproScan:
    ...
    def reset_settings(self):
        ...
        defaults = {
            ...
            "end_zone_length": 0.0,
            "end_zone_step": 0.0,
            "probe_depth": current_probe_depth
        }
