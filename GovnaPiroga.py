...
class COXOproScan:
    ...
    def setup_ui(self):
        ...
        self.root.geometry("850x700")  # Оптимальный размер окна
        ...
        # Настраиваем черные кнопки с белым текстом
